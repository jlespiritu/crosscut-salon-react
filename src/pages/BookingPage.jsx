    ...
    return (
      <div className="px-6 py-24 max-w-2xl mx-auto w-full bg-[#FDFBFB] min-h-screen flex items-center justify-center text-center">
        <div className="bg-white p-12 rounded-3xl shadow-xl border border-gray-100">
          <div className="w-16 h-16 bg-[#C5A059] rounded-full flex items-center justify-center mx-auto mb-6 text-white text-3xl">✓</div>
      ...
      <div className="flex items-center justify-center gap-2 mb-12">
        {[1, 2, 3, 4].map((num) => (
          <div key={num} className="flex items-center">
            ...
            {num < 4 && (
              <div className={`w-12 h-px ${step > num ? 'bg-[#C5A059]' : 'bg-gray-200'}`}></div>
            )}
          </div>
        ))}
      </div>
